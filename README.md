# Gravitational Microlensing Analysis
...
- Handled advanced cases: blended light sources, multi-parameter fits, asymmetric error propagation

**Tools:** MATLAB, statistical modeling, numerical optimization
...
- `images/` — figures (contour maps, lightcurve fits).
- MATLAB script(s) — analysis and χ² fitting code.
